...
export async function sliceProject(rootDir, projectFiles) {
    const allSlices = [];
...
async function readSourceFile(rootDir, filePath) {
...
function sliceFile(content, filePath, language) {
...
function findBlockStarts(lines, language) {
    const starts = [];
