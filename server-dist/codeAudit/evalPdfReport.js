 ...
 * 绘制封面页
 */
function drawCoverPage(doc, evaluation, items, regFont, aeroFont, songFont, fangFont, tnrFont) {
    // 封面主标题：二号 航天腾飞体 居中
 ...
 */
function drawDetailPages(doc, items, regFont, aeroFont, songFont, fangFont, tnrFont) {
    if (items.length === 0)
        return;
    doc.addPage();
    // 一级标题：三号 居中
