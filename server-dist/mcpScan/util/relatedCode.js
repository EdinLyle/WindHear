...
async function readLimited(absPath, maxChars) {
...
async function readWindow(absPath, lineStart, lineEnd, opts) {
...
function pickCallChainFiles(allFiles, ids, limit) {
