/**
 * Skills Audit 正则扫描引擎
 * 覆盖20种风险类型的正则匹配，作为LLM Agent的初步筛选
 */
import type { ProjectFile, RegexMatch, RiskCategory } from '../types.js'
 ...
 * 对项目文件执行正则扫描
 */
export function runRegexScan(projectFiles: ProjectFile[]): RegexMatch[] {
